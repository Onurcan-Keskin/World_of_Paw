...
public class RemoteControlFragment extends Fragment implements ServerManager.IRemoteActionsListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_remote_contol, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        btStartServer.setOnClickListener(v -> {
    ...
    public void onConnectToDevice(Bundle connectInfoBundle) {
        ...
        ((BLE)getActivity()).connectToDeviceByRemoteControl(connectInfoBundle);
    }

    @Override
    public void onDisconnectFromDevice() {
        ((BLE)getActivity()).disconnectFromDeviceByRemoteControl();
        writeResult();
    ...
    public boolean isConnected() {
        return ((BLE)getActivity()).isConnected();
    }
