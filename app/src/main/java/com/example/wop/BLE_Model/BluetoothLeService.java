...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =           "com.example.wop.BLE.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =        "com.example.wop.BLE.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.example.wop.BLE.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =           "com.example.wop.BLE.ACTION_DATA_AVAILABLE";
    public final static String ACTION_RSSI_UPDATE =              "com.example.wop.BLE.ACTION_RSSI_UPDATE";
    public final static String ACTION_MTU_UPDATE =               "com.example.wop.BLE.ACTION_MTU_UPDATE";
    public final static String ACTION_PHY_MODE_AVAILABLE =       "com.example.wop.BLE.ACTION_PHY_MODE_OBTAINED";
    public final static String ACTION_DESCRIPTOR_WRITE =         "com.example.wop.BLE.ACTION_DESCRIPTOR_WRITE";


    public final static String EXTRA_TYPE =             "com.example.wop.BLE.EXTRA_TYPE";
    public final static String EXTRA_UUID =             "com.example.wop.BLE.EXTRA_UUID";
    public final static String EXTRA_DATA =             "com.example.wop.BLE.EXTRA_DATA";
    public final static String EXTRA_RSSI =             "com.example.wop.BLE.EXTRA_RSSI";
    public final static String EXTRA_MTU =              "com.example.wop.BLE.EXTRA_MTU";
    public final static String EXTRA_STATUS =           "com.example.wop.BLE.EXTRA_STATUS";
    public final static String EXTRA_IS_PHY_UPDATE =    "com.example.wop.BLE.EXTRA_IS_PHY_UPDATE";
