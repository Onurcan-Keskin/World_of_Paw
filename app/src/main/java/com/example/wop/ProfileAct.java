...
public class ProfileAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = (ProgressBar) findViewById(R.id.prof_progressbar);
        textView = (TextView) findViewById(R.id.textVerified);
                    ...
                    public void onClick(View v) {
                        user.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                Toast.makeText(ProfileAct.this, R.string.action_verify_sent, Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
            ...
            user.updateProfile(profile).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(ProfileAct.this, R.string.action_profile_update, Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
